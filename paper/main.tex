...
\usepackage{booktabs}
\usepackage{url}
\graphicspath{{figures/}{../results/figures/}{../assets/}{../results/benchmark/}}
\def\BibTeX{{\rm B\kern-.05em{\sc i\kern-.025em b}\kern-.08em T\kern-.1667em\lower.7ex\hbox{E}\kern-.125emX}}

\begin{document}

\title{Swarm-SAR: Decentralized Multi-Agent Reinforcement Learning for\\
Cooperative Search and Rescue under Realistic Constraints}

\author{\IEEEauthorblockN{Mathi Manichandan}
\IEEEauthorblockA{\textit{Autonomous Systems Research} \\
\texttt{https://github.com/mathi0405/drone-swarm-sar}}}
...
\begin{IEEEkeywords}
multi-agent reinforcement learning, drone swarm, search and rescue, CTDE,
