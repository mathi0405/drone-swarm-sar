% Swarm-SAR — self-contained IEEE-style preprint.
% Paste this whole file into a BLANK Overleaf project (main.tex) and hit Recompile.
% It needs NO external figure files and NO separate .bib — figures are captioned
% placeholder boxes and the bibliography is inlined.
%
% To use the real figures instead of a placeholder, replace a \figph{...} line
% with, e.g.:   \includegraphics[width=0.95\linewidth]{fig02_environment.png}
% after uploading the PNGs from results/figures/ to the Overleaf project.
...
% Placeholder box used in place of \includegraphics so the paper compiles with
% no image files present.
\newcommand{\figph}[1]{%
  \fcolorbox{gray!60}{gray!8}{%
    \parbox[c][3.2cm][c]{0.9\linewidth}{\centering\itshape #1\\[4pt]
      \footnotesize[figure placeholder --- replace with \texttt{\textbackslash includegraphics}]}}}
...
\figph{Procedurally generated disaster world}
...
\begin{figure}[t]\centering
\figph{Decentralized communication graph}
...
\begin{figure}[t]\centering
\figph{Graceful degradation vs.\ packet loss}
...
\begin{figure}[t]\centering
\figph{Frozen-benchmark comparison}
